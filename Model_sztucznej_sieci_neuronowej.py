...
Dodatkowo do folderu "input" zostały przeniesiony plik z etykietami "stage1_labels.csv". Folder z danymi testowymi
"stage2" nie został wykorzystany, ponieważ nie była do niego dołączona lista etykiet pacjentów. Zamiast tego przykłady
sprawdzające działania modelu wydzielono z folderu "sample_data".
